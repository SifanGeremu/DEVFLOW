...
import { Zap, Code2, Target, Flame } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <Card className="animate-fade-up border-border/50 backdrop-blur-sm" style={{ animationDelay: '100ms' }}>
          ...
          <CardContent className="space-y-6 pt-4">
            ...
            <div className="grid gap-3">
              ...
              <div className="flex items-center gap-3 p-3 rounded-lg bg-secondary/50">
                ...
                <span className="text-sm text-muted-foreground">
                  Daily curated tasks for your skill level
                </span>
              </div>
              <div className="flex items-center gap-3 p-3 rounded-lg bg-secondary/50">
                <Flame className="h-5 w-5 text-primary shrink-0" />
                <span className="text-sm text-muted-foreground">
                  Build streaks & track your progress
                </span>
              </div>
            </div>
          </CardContent>
